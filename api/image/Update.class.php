...
if ( !empty( $data->user_id ) && !empty($data->title ) && !empty( $data->location )){
    ...
    if ( $img->ft_upload() ){
        ...
        print( json_encode( array( "message" => "Image Failed" )));
    }
}
//Like function
    ...
    if ( $img->ft_like() ){
        ...
        print( json_encode( array( "message" => "Unable to like. Make sure you have the right permissions" )));
    }
}
    ...
    //Recording Image
    if ( $img->ft_comment() ){
        print( json_encode( array( "message" => "Commented", "body" => $data->body )));
    }else{
        print( json_encode( array( "message" => "Unable to comment. Make sure youn have the right permissions" )));
    }
